...
import { LogIn, ShieldCheck, Zap, BellRing } from 'lucide-react';

const LoginPage: React.FC = () => {
    const handleGoogleLogin = () => {
        // Redirect to Spring Boot's OAuth2 initiation endpoint
            ...
            <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 bg-white rounded-[32px] shadow-2xl shadow-indigo-200/50 overflow-hidden relative z-10 border border-white">
                ...
                <div className="p-12 flex flex-col justify-center">
                    <div className="max-w-sm mx-auto w-full text-center md:text-left">
                        ...
                        <p className="text-slate-500 mb-10">Please sign in to access your dashboard.</p>
                        ...
                        >
                            <svg className="w-6 h-6 group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
                                <path
                                    fill="#EA4335"
                                    d="M12 5.04c1.9 0 3.53.68 4.87 1.92l3.62-3.62C18.23 1.34 15.35 0 12 0 7.31 0 3.26 2.69 1.18 6.63l4.22 3.27C6.4 7.21 8.97 5.04 12 5.04z"
                                />
                                <path
                                    fill="#4285F4"
                                    d="M23.49 12.27c0-.85-.07-1.66-.22-2.45H12v4.62h6.45c-.28 1.48-1.12 2.74-2.38 3.58l3.71 2.87c2.17-2 3.42-4.94 3.42-8.62z"
                                />
                                <path
                                    fill="#FBBC05"
                                    d="M5.4 14.75c-.24-.72-.37-1.48-.37-2.25s.13-1.53.37-2.25L1.18 6.63C.43 8.24 0 10.06 0 12c0 1.94.43 3.76 1.18 5.37l4.22-3.27z"
                                />
                                <path
                                    fill="#34A853"
                                    d="M12 24c3.24 0 5.95-1.08 7.94-2.91l-3.71-2.87c-1.04.7-2.38 1.11-4.23 1.11-3.03 0-5.6-2.17-6.52-5.09l-4.22 3.27C3.26 21.31 7.31 24 12 24z"
                                />
                            </svg>
                        ...
                        <div className="mt-10 relative">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-white px-4 text-slate-400">Security Note</span>
                            </div>
                        </div>

                        <p className="mt-8 text-sm text-slate-500 leading-relaxed">
                            By signing in, you agree to our <span className="text-indigo-600 font-medium cursor-pointer hover:underline">Terms of Service</span> and <span className="text-indigo-600 font-medium cursor-pointer hover:underline">Privacy Policy</span>.
                        </p>
                    </div>
                </div>
            </div>
