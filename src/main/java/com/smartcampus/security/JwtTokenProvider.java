...
public class JwtTokenProvider {
    ...
    public String generateToken(com.smartcampus.models.User user) {
        ...
        return Jwts.builder()
                ...
                .claim("role", (user.getRoles() != null && !user.getRoles().isEmpty()) 
                        ? user.getRoles().iterator().next().name() 
                        : "USER")
                .claim("picture", user.getImageUrl())
                .claim("provider", user.getProvider() != null ? user.getProvider() : "LOCAL")
                .claim("phone", user.getPhone() != null ? user.getPhone() : "")
                .claim("department", user.getDepartment() != null ? user.getDepartment() : "")
                .claim("bio", user.getBio() != null ? user.getBio() : "")
                .setIssuedAt(now)
